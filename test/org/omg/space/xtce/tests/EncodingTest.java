    ...
    public void testBinaryParameterTypes() {
        ...
        try {
            ...
            errors += check( 12345678.0,
                             "Payload_MD5 Invalid EU Binary value of '1.2345678E7'" );

            errors += check( (float)1.0,
                             "Payload_MD5 Invalid EU Binary value of '1.0'" );

            errors += check( "FOOBAR",
                             "Payload_MD5 Invalid String value for encoding binary of 'FOOBAR'" );
