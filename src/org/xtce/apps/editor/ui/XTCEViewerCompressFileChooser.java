...
public class XTCEViewerCompressFileChooser extends JFileChooser {
    ...
    /** This dialog creates the File Chooser for selecting an XTCE document for
     * the purpose of applying schema aware compression algorithms, in support
     * of the menu item on the XTCEViewer application.
     *
    ...
    XTCEViewerCompressFileChooser( XTCEViewerPreferences prefs ) {
        ...
        setDialogTitle( XTCEFunctions.getText( "file_chooser_compress_title" ) ); // NOI18N
