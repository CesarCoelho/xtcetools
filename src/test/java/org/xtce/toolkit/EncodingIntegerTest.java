...
public class EncodingIntegerTest {
    ...
    public void testIntegerParameterTypesRawUnsigned() {
        ...
        try {
            ...
            errors += check( "-9",
                             "CCSDSAPID Unsigned value is '-9', which cannot be negative for unsigned encoding" );

            errors += check( "-1",
                             "CCSDSAPID Unsigned value is '-1', which cannot be negative for unsigned encoding" );
            ...
            errors += check( 0xffff,
                             "CCSDSAPID Encoded value '65535' is too large for valid inclusive max value of '2047' on encoding of unsigned" );
    ...
    */
    ...
    private void loadDocument() throws XTCEDatabaseException {
        ...
        String file = "src/test/resources/org/xtce/toolkit/test/BogusSAT-1.xml";
